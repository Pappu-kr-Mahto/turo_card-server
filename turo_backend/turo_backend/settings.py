"""
Django settings for turo_backend project.
...
SECRET_KEY = 'django-insecure-fc(3y)5d!1r98_+oo=f0kgcj(($lgb+8lonuwjf(guqxe2u3-9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1',"turo-card-server.onrender.com"]
...
ROOT_URLCONF = 'turo_backend.urls'
...
WSGI_APPLICATION = 'turo_backend.wsgi.application'
